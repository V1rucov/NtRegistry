...
namespace NTRegistry
{
	...
	public static class NtStatusExtensions
	{
		...
		public static void ThrowIfNotSuccess(this NtStatus status)
		{
			if (!status.IsSuccess())
				throw new NtDllException(status);
		}
	}

	public class NtDllException : Exception
	{
		public NtDllException() : base() { }

		public NtDllException(string msg) : base(msg) { }

		public NtDllException(NtStatus status) : base(String.Format("ntdll.dll call failed. Status: {0:X}", status)) { }
	}
}
